                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 laster-shop-item">
                        <div class="laster-thumb">
                            ...
                            <span class="tz-shop-meta">
                                ...
                                <a href="xu-ly-gio-hang.php?id=<?php echo $pronp['id'];?>&action=add"
                                    class="tzshopping add-cart">
                                    <i class="fa fa-shopping-cart"></i>
                                </a>
                            </span>
                        </div>
                        <h6><a href=""><?php echo $pronp['name']; ?></a></h6>
                        <small style="color: red"><?php echo number_format($pronp['price']);  ?> VNĐ
                        </small>
                    </div>
                    <?php  } ?>
                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 laster-shop-item">
                            ...
                            ?>
                                ...
                                <span class="tz-shop-meta">
                                    ...
                                    <a href="xu-ly-gio-hang.php?id=<?php echo $np['id'];?>&action=add"
                                        class="tzshopping add-cart">
                                        <i class="fa fa-shopping-cart"></i>
                                    </a>
        ...
        <div class="row">
            ...
            <div class="image-add-area">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <!-- SINGLE ADD START -->
                    <div class="onehalf-add-shope zoom-img">
                        <a href="#"><img alt="shope-add" src="img/6859ae561877de2.jpg"></a>
                    </div>
                    <!-- SINGLE ADD END -->
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <!-- SINGLE ADD START -->
                    <div class="onehalf-add-shope zoom-img">
                        <a href="#"><img alt="shope-add" src="img/680316.png"></a>
                    </div>
                    <!-- SINGLE ADD END -->
                </div>
            </div>
        ...
        foreach ($prodyct1 as $tp): 
            ...
            <div class="seller-grids text-center">
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <a href="chitietsp.php?id=<?php echo $tp['id']; ?>"><img src="uploads/<?php echo $tp['image'] ?>"
                            alt="" /></a>
                    <h4 class=""><a href="chitietsp.php?id=<?php echo $tp['id']; ?>"><?php echo $tp['name']; ?></a>
                    </h4>
